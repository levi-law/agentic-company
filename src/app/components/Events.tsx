...
function Events({ isExpanded }: EventsProps) {
  ...
  return (
    <div
      className={
        (isExpanded ? "w-1/2 flex flex-col gap-2" : "w-0 overflow-hidden opacity-0") +
    ...
    >
      {isExpanded && (
        <>
          ...
          <div className="h-1/2 overflow-auto rounded-xl bg-white flex flex-col">
            <Tasks isExpanded={true} />
          </div>

          {/* Logs Panel - Bottom Half */}
          <div className="h-1/2 overflow-auto rounded-xl bg-white flex flex-col" ref={eventLogsContainerRef}>
